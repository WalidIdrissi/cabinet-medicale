...
class DetailAnalyseController extends Controller
{
    ...
    public function update(Request $request, Detail_analyse $detail_analyse)
    {
        ...
        return redirect()->route('detail_analyse.index')->with('success', 'Le detail_analyse a été modifié avec succès.');
    }
    ...
    public function destroy(Detail_analyse $detail_analyse)
    {
        ...
        return redirect()->route('detail_analyse.index')->with('success', 'Le detail_analyse a été supprimé avec succès.');
    }
}
