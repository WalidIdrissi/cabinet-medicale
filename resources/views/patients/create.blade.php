...
<div class='card-header'>
    <div class="text-center font-weight-bold text-uppercase"><h4>Ajouter un nouveau patient </h4></div>
</div>
<div class="card-body">
<form action="{{route('patients.store')}}"method="POST" class="mt-3" >
    @csrf
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" class="form-control" name="poids" placeholder="poids" value="{{old('poids')}}">
    </div>
    <div class="form-group mb-3">
        <label for="taille">TAILLE</label>
        <input type="number" class="form-control" name="taille" placeholder="taille" value="{{old('taille')}}">
    </div>
    <div class="form-group mb-3">
