...
@section('title')
Ajouter un nouveau traitement| Cabinet Medicale App
@endsection
                        ...
                        <div class="card my-5">
                                <div class='card-header'>
                                    ...
                                    <div class="text-center font-weight-bold text-uppercase">
                                        <h4>Ajouter un nouveau traitement </h4>
                    
                                    </div>
                                </div>   
                                <div class="card-body">
                                    <form action="{{route('traitements.store')}}" 
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                name="statut_paiement" placeholder="statut_paiement"
                                                value="{{old('statut_paiement')}}">
